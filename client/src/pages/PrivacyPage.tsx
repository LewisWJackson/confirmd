      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 pt-20 pb-12">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-slate-900 tracking-tighter uppercase leading-[0.9] mb-6">
            Privacy<br />
            <span className="text-cyan-600">Policy</span>
          </h1>
          ...
          <div className="p-8 md:p-14 space-y-16">
            ...
            <div>
              <p className="text-slate-600 font-medium leading-relaxed">
                Confirmd Data Systems ("Confirmd," "we," "us," or "our")
                ...
                the Service, you agree to the practices described in this
                policy.
              </p>
            </div>
              ...
              <div className="space-y-6 text-slate-600 font-medium leading-relaxed">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>
                      <strong>Account Information:</strong> When you create
                      an account, we collect your email address, display
                      name, and password (stored in hashed form).
                    </li>
                    <li>
                      <strong>Subscription Data:</strong> If you subscribe
                      to a paid tier, payment processing is handled by
                      Stripe. We do not store your full credit card number.
                      We receive and store a tokenized reference, billing
                      address, and transaction history.
                    </li>
                    <li>
                      <strong>Watchlist & Preferences:</strong> Assets,
                      claims, and sources you choose to follow or
                      customize.
                    </li>
                    <li>
                      <strong>Communications:</strong> Messages you send
                      us via email or support channels.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li>
                      ...
                      used, search queries, and interaction patterns.
                    </li>
                    <li>
                      <strong>Device Information:</strong> Browser type,
                      operating system, device identifiers, and screen
                      resolution.
                    </li>
                    <li>
                      <strong>Log Data:</strong> IP address, access times,
                      and referring URLs.
                    </li>
                  </ul>
                </div>
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    Personalize your experience, including your feed and
                    watchlist.
                  </li>
                  <li>
                    Send transactional communications (account
                    confirmations, billing receipts, security alerts).
                  </li>
                  <li>
                    Send product updates and feature announcements (you
                  ...
                  <li>
                    Detect and prevent fraud, abuse, or security
                    incidents.
                  </li>
                  <li>
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm space-y-4">
                <p>
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    ...
                    trusted third parties who assist in operating the
                    Service (e.g., Stripe for payments, cloud hosting
                    providers, analytics tools). These providers are
                    contractually bound to protect your data and use it
                    only for the purposes we specify.
                  </li>
                  <li>
                    <strong>Legal Requirements:</strong> We may disclose
                    information if required by law, subpoena, or court
                    order, or if we believe disclosure is necessary to
                    protect our rights, your safety, or the safety of
                    others.
                  </li>
                  <li>
                    <strong>Business Transfers:</strong> In the event of a
                    merger, acquisition, or sale of assets, user data may
                    be transferred. You will be notified of any such
                    change.
                  </li>
                  <li>
                    <strong>With Your Consent:</strong> We may share
                    information for any other purpose with your explicit
                    consent.
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm space-y-4">
                ...
                <p>
                  <strong>CCPA (California):</strong> California residents
                  have the right to know what personal information is
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm space-y-4">
                <p>
                  ...
                  operate and improve the Service. Cookies we use include:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <li>
                    <strong>Essential Cookies:</strong> Required for the
                    Service to function (authentication, session
                    management). Cannot be disabled.
                  </li>
                  <li>
                    <strong>Analytics Cookies:</strong> Help us understand
                    how users interact with the platform. You can opt out
                    of these through your browser settings or our cookie
                    preference center.
                  </li>
                  <li>
                    <strong>Preference Cookies:</strong> Remember your
                    settings, such as watchlist and display preferences.
                  </li>
                </ul>
                <p>
                  We do not use advertising or third-party tracking
                  cookies. You can manage cookie preferences through your
                  browser settings. Disabling essential cookies may impair
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm space-y-3">
                <p>
                  ...
                  and access controls. While no method of transmission over
                  the Internet is 100% secure, we strive to protect your
                  personal information.
                </p>
                <p>
                  We retain personal data for as long as your account is
                  active or as needed to provide the Service. If you delete
                  your account, we will remove your personal data within 30
            ...
            <div>
              ...
              <div className="text-slate-600 font-medium leading-relaxed text-sm">
                <p>
                  ...
                  we do, we will revise the "Last updated" date at the top
                  of this page. For material changes, we will notify you via
                  email or a prominent notice on the Service. Your continued
